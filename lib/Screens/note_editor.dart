...
class _NotesEditorScreenState extends State<NotesEditorScreen> {
  ...
  var date =
      DateFormat("dd-MM-yyyy hh:mm:aa").format(DateTime.now()).toString();

  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        backgroundColor: Color.fromARGB(255, 255, 204, 136),
        appBar: AppBar(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                maxLines: null,
                controller: _noteContentContoller,
                decoration: InputDecoration(
                    border: InputBorder.none, hintText: 'Type your Content'),
              )
            ],
          ),
        ),
        floatingActionButton: FloatingActionButton.extended(
          ...
          onPressed: () async {
            FirebaseFirestore.instance.collection("Notes").add({
              ...
              "creation_date": date,
              "note_content": _noteContentContoller.text
            }).then((value) {
              print(value.id);
